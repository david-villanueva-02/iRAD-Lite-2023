...
class OffboardControl(Node):
    ...
    def timer_callback(self) -> None:
        ...
        if abs(X) < 0.5 and abs(Y) < 0.5 and abs(Z + 5) < 0.5:   
            self.publish_vehicle_command(VehicleCommand.VEHICLE_CMD_DO_ORBIT, param1 = 50.0, param2 = 10.0, param3 = 0.0, param5 = self.vehicle_local_position.ref_lat, param6 = self.vehicle_local_position.ref_lon, param7 = self.vehicle_local_position.ref_alt)
